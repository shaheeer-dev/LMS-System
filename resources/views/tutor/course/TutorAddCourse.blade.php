    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row ">
                ...
                <!--/.col (center) -->
                <div class="col-md-4">
                    <form action="{{route('register-course', $view->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-footer" id="add_course_footer">
                            <div class="row ">
                                ...
                                <div class="col-sm-4 col-4">
                                    <div class="description-block">
                                        <h5 class="description-header">35</h5> <span class="description-text">Student</span> </div>
                                    <!-- /.description-block -->
                                </div>
                                <!-- /.col -->
                            </div>
